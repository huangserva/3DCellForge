...
export const ATLASCLOUD_API_KEY = process.env.ATLASCLOUD_API_KEY
export const ATLASCLOUD_API_BASE = process.env.ATLASCLOUD_API_BASE || 'https://api.atlascloud.ai/api/v1'
export const ATLASCLOUD_3D_MODEL = process.env.ATLASCLOUD_3D_MODEL || 'tencent/hunyuan3d-rapid/image-to-3d'
